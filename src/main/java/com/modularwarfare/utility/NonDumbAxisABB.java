...
public class NonDumbAxisABB
{
    ...
    /**
     * Helper method that returns a new {@link NonDumbAxisABB} with the given value for {@link #maxY} and all other
    ...
    public boolean equals(Object p_equals_1_)
    {
        ...
        else if (!(p_equals_1_ instanceof NonDumbAxisABB))
        {
            return false;
        }
        else
    ...
    /**
     * Creates a new {@link NonDumbAxisABB} that has been contracted by the given amount, with positive changes
    ...
    /**
     * Creates a new {@link NonDumbAxisABB} that has been expanded by the given amount, with positive changes increasing
    ...
    /**
     * Creates a new {@link NonDumbAxisABB} that has been contracted by the given amount in both directions. Negative
    ...
    /**
     * Creates a new {@link NonDumbAxisABB} that is expanded by the given value in all directions. Equivalent to {@link
    ...
    {
        return new NonDumbAxisABB(this.minX + (double)pos.getX(), this.minY + (double)pos.getY(), this.minZ + (double)pos.getZ(), this.maxX + (double)pos.getX(), this.maxY + (double)pos.getY(), this.maxZ + (double)pos.getZ());
    }
