...
public class stg44 extends ModelGun {
    ...
    public stg44() {
        ...
        gunModel[0].addObj("highres/obj/guns/stg44/body");
        gunModel[0].setRotationPoint(0F, 0F, 0F);

        ammoModel = new ModelRendererTurbo[1];

        ammoModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 0
        ammoModel[0].addObj("highres/obj/guns/stg44/ammo");
        ...
        slideModel[0].addObj("highres/obj/guns/stg44/slide");
