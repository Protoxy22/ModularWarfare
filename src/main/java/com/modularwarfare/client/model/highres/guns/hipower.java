...
public class hipower extends ModelGun {
    ...
    public hipower() {
        ...
        rightArmReloadPos = new Vector3f(0.5F, -0.55F, 0.0F);
        ...
        modelScale = 0.9F;
        translateAll = new Vector3f(2F, -2.05F, -0.01F);
