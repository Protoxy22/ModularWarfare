...
public class ppsh extends ModelGun {
    ...
    public ppsh() {
        ...
        gunModel[0].addObj("highres/obj/guns/ppsh/body");
        gunModel[0].setRotationPoint(0F, 0F, 0F);

        ammoModel = new ModelRendererTurbo[1];

        ammoModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 0
        ammoModel[0].addObj("highres/obj/guns/ppsh/ammo");
        ...
        slideModel[0].addObj("highres/obj/guns/ppsh/slide");
        ...
        rightArmPos = new Vector3f(0.26F, -0.63F, 0.0F);
        ...
        translateAll = new Vector3f(1.5F, -1.9F, -0.06F);
