...
public class bar extends ModelGun {
    ...
    public bar() {
        ...
        gunModel[0].addObj("highres/obj/guns/bar/body");
        gunModel[0].setRotationPoint(0F, 0F, 0F);

        ammoModel = new ModelRendererTurbo[1];

        ammoModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 0
        ammoModel[0].addObj("highres/obj/guns/bar/ammo");
        ...
        slideModel[0].addObj("highres/obj/guns/bar/slide");
        ...
        rotateAimPosition = new Vector3f(0F, 0.065F, 0.2F);
