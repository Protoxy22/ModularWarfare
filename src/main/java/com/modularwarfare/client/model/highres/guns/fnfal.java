...
public class fnfal extends ModelGun {
    ...
    public fnfal() {
        ...
        gunModel[0].addObj("highres/obj/guns/fnfal/body");
        gunModel[0].setRotationPoint(0F, 0F, 0F);

        ammoModel = new ModelRendererTurbo[1];

        ammoModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 0
        ammoModel[0].addObj("highres/obj/guns/fnfal/ammo");
        ...
        translateAll = new Vector3f(1F, -1.85F, -0.055F);
