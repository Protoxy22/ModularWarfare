...
public class pkm extends ModelGun {
    ...
    public pkm() {
        ...
        gunModel[0].addObj("highres/obj/guns/pkm/body");
        gunModel[0].setRotationPoint(0F, 0F, 0F);

        ammoModel = new ModelRendererTurbo[1];

        ammoModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 0
        ammoModel[0].addObj("highres/obj/guns/pkm/ammo");
        ...
        slideModel[0].addObj("highres/obj/guns/pkm/slide");
