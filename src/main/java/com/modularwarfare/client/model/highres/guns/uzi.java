...
public class uzi extends ModelGun {
    ...
    public uzi() {
        ...
        gunModel[0].addObj("highres/obj/guns/uzi/body");
        gunModel[0].setRotationPoint(0F, 0F, 0F);

        ammoModel = new ModelRendererTurbo[1];

        ammoModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 0
        ammoModel[0].addObj("highres/obj/guns/uzi/ammo");
        ...
        slideModel[0].addObj("highres/obj/guns/uzi/slide");
        ...
        rightArmPos = new Vector3f(0.36F, -0.63F, 0.0F);
        rightArmRot = new Vector3f(0.0F, 0.0F, -90.0F);
        rightArmReloadPos = new Vector3f(0.36F, -0.63F, 0.0F);
        ...
        leftArmScale = new Vector3f(0, 0, 0);
        ...
        translateAll = new Vector3f(2F, -1.9F, -0.06F);
