...
public class thompson extends ModelGun {
    ...
    public thompson() {
        ...
        gunModel[0].addObj("highres/obj/guns/thompson/body");
        gunModel[0].setRotationPoint(0F, 0F, 0F);

        ammoModel = new ModelRendererTurbo[1];

        ammoModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 0
        ammoModel[0].addObj("highres/obj/guns/thompson/ammo");
        ...
        slideModel[0].addObj("highres/obj/guns/thompson/slide");
        slideModel[0].setRotationPoint(0F, 0F, 0F);

        leftArmPos = new Vector3f(0.15F, -0.59F, 0.06F);
        ...
        rightArmPos = new Vector3f(0.4F, -0.6F, 0.0F);
        ...
        hasFlash = true;
        flashScale = 1.5F;
        this.muzzleFlashPointNormal = new Vector3f(0F, 0.55F, 1.3F);
        ...
        translateAll = new Vector3f(3F, -1.9F, -0.065F);
