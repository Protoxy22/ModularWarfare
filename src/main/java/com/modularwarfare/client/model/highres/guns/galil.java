...
public class galil extends ModelGun {
    ...
    public galil() {
        ...
        gunModel[0].addObj("highres/obj/guns/galil/body");
        gunModel[0].setRotationPoint(0F, 0F, 0F);

        ammoModel = new ModelRendererTurbo[1];

        ammoModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 0
        ammoModel[0].addObj("highres/obj/guns/galil/ammo");
        ...
        slideModel[0].addObj("highres/obj/guns/galil/slide");
        ...
        translateAll = new Vector3f(1F, -1.9F, -0.05F);
