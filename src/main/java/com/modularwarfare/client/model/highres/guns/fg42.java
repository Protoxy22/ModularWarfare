...
public class fg42 extends ModelGun {
    ...
    public fg42() {
        ...
        gunModel[0].addObj("highres/obj/guns/fg42/body");
        gunModel[0].setRotationPoint(0F, 0F, 0F);

        ammoModel = new ModelRendererTurbo[1];

        ammoModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 0
        ammoModel[0].addObj("highres/obj/guns/fg42/ammo");
        ...
        slideModel[0].addObj("highres/obj/guns/fg42/slide");
        slideModel[0].setRotationPoint(0F, 0F, 0F);

        leftArmPos = new Vector3f(0F, -0.65F, 0.06F);
        leftArmRot = new Vector3f(65.0F, 32.0F, -46.0F);
        leftArmReloadPos = new Vector3f(-0.35F, -0.6F, 0.02F);
        leftArmReloadRot = new Vector3f(35.0F, 0.0F, -25.0F);

        rightArmPos = new Vector3f(0.26F, -0.65F, 0.0F);
        rightArmRot = new Vector3f(0.0F, 0.0F, -90.0F);
        rightArmReloadPos = new Vector3f(0.35F, -0.65F, 0.04F);
        ...
        translateAll = new Vector3f(3F, -1.9F, -0.05F);
        this.crouchZoom = -0.3f;

        this.reloadAnimation = WeaponAnimations.RIFLE;
