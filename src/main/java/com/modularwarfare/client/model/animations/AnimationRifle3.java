...
public class AnimationRifle3 extends WeaponAnimation {
	...
	public void onGunAnimation(float tiltProgress, float adsSwitch)
	{
		...
		//Translate Y - Up/Down
		GL11.glTranslatef(0F, 0.2F * tiltProgress + (-0.064F * adsSwitch * tiltProgress), 0F);
		...
		GL11.glRotatef(30F * tiltProgress + (1F * adsSwitch), 0F, 0F, 1F);
	...
	public void onAmmoAnimation(ModelGun gunModel, float clipPosition, float reloadRotate)
	{
		...
		//Rotate Z axis - Angle Up/Down
		GL11.glRotatef(-50F * clipPosition, 0F, 0F, 1F);
