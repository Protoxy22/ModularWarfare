...
public class ump45 extends ModelGun //Same as Filename
{
	...
	public ump45() //Same as Filename
	{
		...
		translateAll = new Vector3f(0F, -10.5F, -0.1F);//forward/down/right
        ...
        rightArmPos = new Vector3f(0.60F, -0.65F, 0.0F);
        rightArmRot = new Vector3f(0.0F, 0.0F, -90.0F);
        rightArmReloadPos = new Vector3f(0.60F, -0.65F, 0.0F);
        ...
        ammoMap.put("mwp.ump45triplemag", new RenderVariables(new Vector3f(0F, 0F, 0F), 0.12F));
