...
public class fg42 extends ModelGun //Same as Filename
{
	int textureX = 128;
	int textureY = 128;

	public fg42() //Same as Filename
	{
		...
		gunModel[66] = new ModelRendererTurbo(this, 121, 25, textureX, textureY); // Box 72
		...
		gunModel[40].setRotationPoint(-3F, -4.37F, -0.51F);
		...
		gunModel[66].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, -0.42F, 0F, -0.4F, -0.42F, 0F, -0.4F, -0.42F, 0F, -0.4F, -0.42F, 0F, -0.4F, -0.42F, 0F, -0.4F, -0.42F, 0F, -0.4F, -0.42F, 0F, -0.4F, -0.42F, 0F, -0.4F); // Box 72
		gunModel[66].setRotationPoint(3.23F, -1.9F, -0.51F);
		gunModel[66].rotateAngleZ = 0.15707963F;



		defaultScopeModel = new ModelRendererTurbo[4];
		defaultScopeModel[0] = new ModelRendererTurbo(this, 97, 49, textureX, textureY); // Box 68
		defaultScopeModel[1] = new ModelRendererTurbo(this, 9, 49, textureX, textureY); // Box 69
		defaultScopeModel[2] = new ModelRendererTurbo(this, 105, 49, textureX, textureY); // Box 70
		defaultScopeModel[3] = new ModelRendererTurbo(this, 113, 49, textureX, textureY); // Box 72

		defaultScopeModel[0].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, -0.35F, 0F, -0.4F, -0.35F, 0F, -0.4F, -0.35F, 0F, -0.4F, -0.35F, 0F, -0.4F, -0.35F, 0F, -0.4F, -0.35F, 0F, -0.4F, -0.35F, 0F, -0.4F, -0.35F, 0F, -0.4F); // Box 68
		defaultScopeModel[0].setRotationPoint(20.25F, -5.5F, -0.51F);

		defaultScopeModel[1].addShapeBox(0F, 0F, 0F, 1, 5, 5, 0F, -0.3F, -2.25F, -2.25F, -0.3F, -2.25F, -2.25F, -0.3F, -2.25F, -2.25F, -0.3F, -2.25F, -2.25F, -0.3F, -2.25F, -2.25F, -0.3F, -2.25F, -2.25F, -0.3F, -2.25F, -2.25F, -0.3F, -2.25F, -2.25F); // Box 69
		defaultScopeModel[1].setRotationPoint(20.25F, -8.25F, -2.51F);

		defaultScopeModel[2].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, -0.3F, 0F, -0.4F, -0.3F, 0F, -0.4F, -0.3F, 0F, -0.4F, -0.3F, 0F, -0.4F, -0.3F, 0F, -0.4F, -0.3F, 0F, -0.4F, -0.3F, 0F, -0.4F, -0.3F, 0F, -0.4F); // Box 70
		defaultScopeModel[2].setRotationPoint(0.25F, -5.5F, -0.5F);

		defaultScopeModel[3].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, -0.35F, 0F, -0.47F, -0.35F, 0F, -0.47F, -0.35F, 0F, -0.47F, -0.35F, 0F, -0.47F, -0.35F, 0F, -0.47F, -0.35F, 0F, -0.47F, -0.35F, 0F, -0.47F, -0.35F, 0F, -0.47F); // Box 72
		defaultScopeModel[3].setRotationPoint(0.25F, -5.78F, -0.5F);
		...
		translateAll = new Vector3f(0F, -1.8F, -0.01F);
	    ...
	    leftArmPos = new Vector3f(0.280F, -0.62F, 0.02F);
	    leftArmRot = new Vector3f(65.0F, 30.0F, -45.0F);
		leftArmReloadPos = new Vector3f(-0.050F, -0.5F, -0.3F);
	    leftArmReloadRot = new Vector3f(35.0F, 0.0F, -25.0F);
	    
	    rightArmPos = new Vector3f(0.38F, -0.635F, 0.0F);
	    rightArmRot = new Vector3f(0.0F, 0.0F, -90.0F);
	    rightArmReloadPos = new Vector3f(0.38F, -0.635F, 0.0F);
